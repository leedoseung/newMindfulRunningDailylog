          ...
          return (
            ...
            >
              <div style={{
                ...
                {run.photoUrl && (
                  <>
                    <div style={{ position: 'absolute', inset: 0, borderRadius: 20, backgroundImage: `url(${toTransformedUrl(run.photoUrl, 1200)})`, backgroundSize: 'cover', backgroundPosition: 'center', filter: 'blur(18px)', transform: 'scale(1.12)', opacity: 0.9 }} />
                    <div style={{ position: 'absolute', inset: 0, borderRadius: 20, backgroundImage: `url(${toTransformedUrl(run.photoUrl, 1200)})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }} />
                  </>
                )}
